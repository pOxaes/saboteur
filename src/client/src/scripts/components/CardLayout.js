  ...
  >
    ...
    {item === "GOLD" &&
      <g className="svg-card-path__item--gold">
        <path
          className="gold-color-1"
          d="M60.8,99.2c1.4,0.2,2.3-0.7,2.8-3.5c0.5-2.8,0.8-4.7,1.1-6.7c0.3-2,0.1-3.1-2.2-6c-2.3-2.9-2.9-3.1-5.7-5.9
        ...
        />
        <path
          className="gold-color-2"
          d="M60.8,99.2c-2.2-0.5-5.1-1.2-11.1-2.9c-4.5-1.3-7.9-2.7-9.4-3.3c0.2,1,1,1.6,2,3.1c3.3,3.3,5.7,5.6,7.4,6.8
            c1.5,1.2,4.3,1.9,10.9,1.7c1.1-0.1,2.2-0.2,3.3-0.3l-1.8-5.3C61.8,99.2,61.3,99.3,60.8,99.2z"
        />
        <path
          className="gold-color-3"
          d="M65.9,87.8c1.1,0.2,10.9,2.4,14.1,3c-0.2-1.6-1.7-2.6-3.4-4.1c-1.8-1.6-12.2-8.5-17.5-11.6
        ...
        />
        <path
          className="gold-color-4"
          d="M80,90.9c-3.1-0.7-13-2.8-14.1-3c-0.7-0.1-1,0.4-1.2,0.9c0,0.1,0,0.1,0,0.2c-0.3,2-0.5,3.9-1.1,6.7
    ...
    {item === "LADDER" &&
      <g className="svg-card-path__item--ladder">
        ...
        <path
          className="ladder-color-1"
          d="M56.5,69l0.7-0.4l2.7,0.2l7.6,26.6c-1.3,0.3-2.7,0.5-3.5,0.5L56.5,69z"
        />
        <path
          className="ladder-color-2"
          d="M52.2,76.4l6.5-3.4c0,0,0.3-0.1,0.5,0.2s0.1,0.7,0.1,0.7l-6.7,3.5L52.2,76.4z"
        />
        <path
          className="ladder-color-2"
          d="M53.8,82.1l6.5-3.4c0,0,0.3-0.1,0.5,0.2s0.1,0.7,0.1,0.7l-6.7,3.5L53.8,82.1z"
        />
        <path
          className="ladder-color-2"
          d="M55.3,87.9l6.5-3.4c0,0,0.3-0.1,0.5,0.2s0.1,0.7,0.1,0.7l-6.7,3.5L55.3,87.9z"
        />
        <path
          className="ladder-color-2"
          d="M56.7,93.5l6.5-3.4c0,0,0.3-0.1,0.5,0.2s0.1,0.7,0.1,0.7L57,94.6L56.7,93.5z"
        />
        <path
          className="ladder-color-3"
          d="M48,73.7l0.7-0.4l2.7,0.2l6.1,21.6c-1.4-0.5-2.7-0.9-4.2-2.1L48,73.7z"
        />
      </g>}
  </svg>;
