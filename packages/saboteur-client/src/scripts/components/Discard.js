...
function computeDiscardClassName(highlight) {
  return ["discard", highlight && "discard--highlight"].join(" ");
}

export default ({ onDiscard, highlight }) =>
  <div
    className={computeDiscardClassName(highlight)}
    id="discard"
    onClick={() => {
      onDiscard && onDiscard();
    }}
  >
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 146.1 167.3"
      xmlSpace="preserve"
    >
      <path
        id="bin"
        d="M0,0v14h8.5L20,152.8c0.7,8.2,7.6,14.5,15.8,14.5h74.4c8.2,0,15.1-6.4,15.8-14.5L137.6,14h8.5V0H0z
