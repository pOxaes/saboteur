...
const contains = (list, str) => list.indexOf(str) > -1;

export default ({ action, subtype }) =>
  <svg
    version="1.1"
    className="svg-card-action"
  ...
  >
    {action === "FREE" &&
      ...
      <polygon
        name="BG"
        className="card--action-FREE--bg"
        points="63,0 0,88 0,0 "
      />}
    {action === "BLOCK" &&
      contains(subtype, "CHARIOT") &&
      <path
        name="TRAP"
        d="M55.3,78.8L31.8,12.3c0-0.1,0-0.1,0-0.2c0-0.3-0.1-0.6-0.3-0.9V0h-2v11.1c-0.3,0.3-0.4,0.6-0.4,1
...
l-0.2-6.2c1-0.1,2.1-0.2,3.2-0.3l0.7,6.6C36,80.8,34.7,80.8,33.5,80.7z"
 ...
 c3.4-2.8,8.3-2.5,11,0.7C70,53.5,69.5,58.4,66.2,61.3z" />
        <ellipse
          transform="matrix(0.9363 -0.3511 0.3511 0.9363 -13.0388 16.1234)"
          cx="37.9"
          cy="44"
          rx="1.5"
          ry="1.5"
    ...
    {action === "BLOCK" &&
      contains(subtype, "PICKAXE") &&
      <g name="POISON">
        <path
          name="z_2_"
          d="M28.9,11.4l-7,9l7.8-1l0.6,5.4l-15.7,2.6l-1.4-4.9l8-9.9l-8.4,1.6L12.2,9L28,6.8L28.9,11.4z"
        />
        <path
          name="z_1_"
          d="M44.7,18.4l-5.6,7.2l6.2-0.8l0.5,4.3l-12.5,2.1l-1.1-3.9l6.4-7.9l-6.7,1.3l-0.6-4.1l12.6-1.7
 L44.7,18.4z"
        />
        <path
          name="z"
          d="M32.1,35.9l-3.7,4.7l4.1-0.6l0.3,2.9l-8.3,1.4l-0.7-2.6l4.2-5.2l-4.4,0.8l-0.4-2.7l8.3-1.1L32.1,35.9z"
        />
        <path
          name="poison_1_"
          d="M20.2,83.6l33.4-4.5L41.2,62.7l-0.8-6.2l2.4-0.3l-1-7.5l-18.2,2.4l1,7.5l2.4-0.3l0.8,6.2
 L20.2,83.6z M26.4,56.2l-0.4-3.3l14-1.9l0.4,3.3L38,54.6l1.2,8.8l10.5,14.1l-26.2,3.5l6.4-16.3l-1.2-8.8L26.4,56.2z"
        />
        <polygon
          name="poison"
          points="25.6,79.4 47.2,76.5 40.4,67.3 39.2,67.5 42.8,72.1 37.8,67.7 29.8,68.7 	"
        />
      </g>}
    {action === "FREE" &&
      contains(subtype, "PICKAXE") &&
      <g name="HEAL">
        <path
          name="heal-2"
          d="M24.2,89l-3.3-2.6l5.2-6.4l3.7,2.9l21.1-26.3L49,55.1l1.7-2.2l-2.8-2.2l1.6-2l-1.4-1.2l9.6-12
 ...
 l-10.1-8L21.5,68.3z"
        ...
        <polygon
          name="heal-1"
          points="18.8,7.5 29.5,36.6 33.9,17 39.8,27.8 49.5,26.7 49.9,30.5 37.7,31.9 35.4,27.7 
 30.3,50.2 20.5,23.2 18.9,34.5 5.3,36 4.9,32.2 15.5,31 	"
        />
      </g>}
    {action === "BLOCK" &&
      contains(subtype, "LIGHT") &&
      <g name="TORCH">
        <polygon
          name="torch2"
          points="20.7,59.6 25.8,67.9 28.3,75.6 36.7,66.7 29.7,62.5 	"
        />
        <path
          name="torch3"
          d="M25.2,69c-0.4-1-5.6-7.5-5.6-7.5l-2.8,8.8l-5.5,15.4l-6.9,25.3c0,0,1.5,2.7,2.4,1.5
 c0.9-1.3,20.1-35.6,20.1-35.6S25.6,70,25.2,69z"
        />
        <polygon
          name="torch1"
          points="32.9,54.3 23.2,52 22.3,55.1 22,55.2 22.3,55.2 21.6,57.6 29.5,60 37.7,65 41.2,59.3 	"
        />
        <path
          name="smoke"
          d="M44.6,15.9c0-1.5-0.2-2.9-0.6-4.2c-0.4-1.3-0.9-2.3-1.5-3.2c-0.6-0.9-1.2-1.5-1.8-2
 ...
 C44.6,16.7,44.6,16.3,44.6,15.9z"
        ...
        <path
          name="smoke_1_"
          d="M37.1,5.8c0-1.5-0.2-2.9-0.6-4.2c-0.4-1.3-0.9-2.3-1.5-3.2c-0.6-0.9-1.2-1.5-1.8-2
 ...
 C37.1,6.5,37.1,6.2,37.1,5.8z"
    ...
    {action === "FREE" &&
      ...
      <g name="MATCHES">
        <path
          name="matches_1_"
          d="M66.7,33.7L65.3,34L63,25.4c0.6-1.2,0.8-2.8,0.3-4.5c-0.8-2.9-2.9-4.8-4.8-4.3
 ...
 l59.7-15.7l6.5,24.8L14.2,79.3z"
        ...
        <path
          name="zip"
          d="M65.3,54.7l-48,12.6c-0.8,0.2-1.3,1-1.1,1.8l1.2,4.4c0.2,0.8,1,1.3,1.8,1.1l48-12.6
 c0.8-0.2,1.3-1,1.1-1.8l-1.2-4.4C66.9,55,66.1,54.5,65.3,54.7z"
    ...
    {action === "DESTROY" &&
      <path
        name="TNT"
        d="M56.1,33.8l-3.2,1.1l-0.7-2.1l-6,2l0.7,2.1l-6.5,2.2l-1.5-4.5l-3.8,1.3l-4.9-14.8l12-4
...
l-3.9,1.3L57,70.2L54.9,70.9z"
    ...
    {action === "REVEAL" &&
      <path
        name="REVEAL"
        d="M57.5,18.3c-9.1-8.9-20.9-11.5-26.4-5.9c-0.6,0.6-1,1.2-1.4,1.9L11.9,38.2c0,0,0,2,0.5,4.9
